...
1. As a first step, add the logic to conditionally display text depending on whether the user is signed in by adding the following code to the top of the `<body>` tag in `application.html.erb`:
